...
for dafei in range(3):
    ...
    # -------------------------------------------------------------------
    grad = testAdv_grad(test_epi=10, adv_mag=0.1, samp_time =20) 
    van = test(test_epi=10, adv_mag=0.1, samp_time =20) 
    pa = testAdv_pa (test_epi=10, adv_mag=0.1, samp_time =20) 
    pa_samp = testAdv_pa_samp(test_epi=10, adv_mag=0.1, samp_time =20)
    sgd = testAdv_sgd(test_epi=10, adv_mag=0.1, samp_time =20)  
