...
for i in mag_adv: 
	for j in range(10): 
		...
		#a_sgd,rewardList_sgd=dqn.testAdv_sgd(env, nb_episodes=10, visualize=False, mag_adv = 0.05, prob = 1., samp_time =10)
		...
		with open('adv_test_mag_{}_test#{}_samp_{}_time_{}.pickle'.format(i, j, samp_time,timestr),'wb') as f:
		    pickle.dump(store, f,pickle.HIGHEST_PROTOCOL)
